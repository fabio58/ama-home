                                    ...
                                    <td>@{{ item.id }}</td>
                                        ...
                                        <td>
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-auto">
                                                <a class="btn btn-sm btn-spinner btn-info" :href="'/admin/applicant-documents/'+item.id+'/create'" title="{{ trans('brackets/admin-ui::admin.btn.documentsatc') }}" role="button"><i class="fa fa-file-o"></i></a>
                                                </div>
