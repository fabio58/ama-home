...
class FillPermissionsForApplicantAnswer extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForApplicantAnswer constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.applicant-answer',
            'admin.applicant-answer.index',
            'admin.applicant-answer.create',
            'admin.applicant-answer.show',
            'admin.applicant-answer.edit',
            'admin.applicant-answer.delete',
            'admin.applicant-answer.bulk-delete',
        ]);
