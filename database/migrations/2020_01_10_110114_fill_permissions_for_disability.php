...
class FillPermissionsForDisability extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDisability constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.disability',
            'admin.disability.index',
            'admin.disability.create',
            'admin.disability.show',
            'admin.disability.edit',
            'admin.disability.delete',
            'admin.disability.bulk-delete',
        ]);
