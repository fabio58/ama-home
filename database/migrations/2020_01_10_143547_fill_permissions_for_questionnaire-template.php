...
class FillPermissionsForQuestionnaireTemplate extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForQuestionnaireTemplate constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.questionnaire-template',
            'admin.questionnaire-template.index',
            'admin.questionnaire-template.create',
            'admin.questionnaire-template.show',
            'admin.questionnaire-template.edit',
            'admin.questionnaire-template.delete',
            'admin.questionnaire-template.bulk-delete',
        ]);
