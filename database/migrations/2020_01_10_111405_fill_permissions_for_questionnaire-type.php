...
class FillPermissionsForQuestionnaireType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForQuestionnaireType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.questionnaire-type',
            'admin.questionnaire-type.index',
            'admin.questionnaire-type.create',
            'admin.questionnaire-type.show',
            'admin.questionnaire-type.edit',
            'admin.questionnaire-type.delete',
            'admin.questionnaire-type.bulk-delete',
        ]);
