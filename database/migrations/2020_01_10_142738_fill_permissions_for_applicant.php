...
class FillPermissionsForApplicant extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForApplicant constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.applicant.create',
            'admin.applicant.show',
            'admin.applicant.edit',
            'admin.applicant.delete',
            'admin.applicant.bulk-delete',
        ]);
