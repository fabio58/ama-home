...
class FillPermissionsForApplicantDocument extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForApplicantDocument constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.applicant-document.index',
            'admin.applicant-document.create',
            'admin.applicant-document.show',
            'admin.applicant-document.edit',
            'admin.applicant-document.delete',
            'admin.applicant-document.bulk-delete',
        ]);
