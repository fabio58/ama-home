...
class FillPermissionsForContactMethod extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForContactMethod constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.contact-method.index',
            'admin.contact-method.create',
            'admin.contact-method.show',
            'admin.contact-method.edit',
            'admin.contact-method.delete',
            'admin.contact-method.bulk-delete',
        ]);
