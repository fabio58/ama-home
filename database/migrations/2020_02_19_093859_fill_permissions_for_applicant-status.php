...
class FillPermissionsForApplicantStatus extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForApplicantStatus constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.applicant-status.index',
            'admin.applicant-status.create',
            'admin.applicant-status.show',
            'admin.applicant-status.edit',
            'admin.applicant-status.delete',
            'admin.applicant-status.bulk-delete',
        ]);
