...
class FillPermissionsForApplicantRelationship extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForApplicantRelationship constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.applicant-relationship',
            'admin.applicant-relationship.index',
            'admin.applicant-relationship.create',
            'admin.applicant-relationship.show',
            'admin.applicant-relationship.edit',
            'admin.applicant-relationship.delete',
            'admin.applicant-relationship.bulk-delete',
        ]);
