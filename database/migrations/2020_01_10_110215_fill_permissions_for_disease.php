...
class FillPermissionsForDisease extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDisease constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.disease',
            'admin.disease.index',
            'admin.disease.create',
            'admin.disease.show',
            'admin.disease.edit',
            'admin.disease.delete',
            'admin.disease.bulk-delete',
        ]);
