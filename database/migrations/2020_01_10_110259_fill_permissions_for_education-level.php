...
class FillPermissionsForEducationLevel extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEducationLevel constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.education-level',
            'admin.education-level.index',
            'admin.education-level.create',
            'admin.education-level.show',
            'admin.education-level.edit',
            'admin.education-level.delete',
            'admin.education-level.bulk-delete',
        ]);
